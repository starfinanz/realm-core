...
TEST(MemoryStream_InputBasic)
{
    ...
    CHECK_EQUAL(in.tellg(), std::streampos(0));
    ...
    CHECK_EQUAL(in.eof(), false);
    CHECK_EQUAL(in.tellg(), std::streampos(3));

    in >> sp;
    CHECK_EQUAL(sp, ' ');
    CHECK_EQUAL(in.eof(), false);
    CHECK_EQUAL(in.tellg(), std::streampos(4));
    ...
    CHECK_EQUAL(in.tellg(), std::streampos(-1));
}
...
TEST(MemoryStream_InputSeek)
{
    ...
    // No buffer
    CHECK_EQUAL(std::streampos(0), in.tellg());
    in.seekg(0);
    CHECK(in);
    CHECK_EQUAL(std::streampos(0), in.tellg());
    in.seekg(0);
    ...
    in.seekg(1);
    CHECK(in);
    CHECK_EQUAL(std::streampos(1), in.tellg());
    in.seekg(2);
    CHECK(in);
    CHECK_EQUAL(std::streampos(2), in.tellg());
